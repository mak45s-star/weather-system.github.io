...
const apiKey = 'ab79b0e6d2c10b837252d06e9fab6acc'
     ...
     if (id <= 321) return'drizzle.svg'
      if (id <= 531) return'rain.svg'
       if (id <= 622) return'snow.svg'
        if (id <= 781) return'atmosdhere.svg'
         if (id <= 801) return'clear.svg'
...
async function updateWeatherInfo(city) {
    ...
    windValueTxt.textContent = speed + 'м/c'
...
function updateForecastsItems(weatherData) {
    ...
    const dateResult = dateTaken.toLocaleDateString('uk-UA', dateOption)
